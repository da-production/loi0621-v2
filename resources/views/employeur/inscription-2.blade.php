{{-- 
    ...
    @Route(
        url: '/employeur/inscription'
        name: 'employeur.inscription'
    )
    ...
    @Compononents:[
        employeur.inscription2-component
    ]
...
<script src="{{ asset('assets/js/jquery.inputmask.min.js') }}"></script>
    ...
    <script>
        let code = $("#code_employeur_cnas").val();
        axios.post('{{ route("employeur.code.check2") }}',{code})
