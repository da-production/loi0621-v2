    ...
    <div data-step="3" data-intro="Rubrique de Suivi des Notifications, ici, vous serez averti lorsque vous aurez une nouvelle Notification" >
        ...
        <div class="element-box-tp">
            <div class="el-buttons-list full-width">
                <a class="btn btn-success btn-sm" href="?notification=confirmation"><i class="os-icon os-icon-check-circle"></i><span>Confirmation de l'Inscription</span></a>
                ...
                @if (!is_null($demande->traitement_dos))
                    @if (Carbon\Carbon::now()->toDateTimeString() >= $demande->date_traitement_dos)   
