...
<h5  class="text-center">Récépissé de dépôt de dossier N°<b>{{ $employeur->wilaya->cod_wilaya }}/{{ $demande->ref_reception}}/{{ Carbon\Carbon::parse($demande->created_at)->format("Y") }}</b></h5>
<br>
<br>
<ul class="text-justify">
    ...
    <li>Nature de l’avantage demandé : <b>Formation</b></li>
