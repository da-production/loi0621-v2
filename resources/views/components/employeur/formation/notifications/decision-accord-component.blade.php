...
<p class="text-justify">Après examen de votre dossier, nous avons l’honneur de porter à votre connaissance qu’une suite favorable a été réservée à votre demande et vous demandons de bien vouloir vous présenter à l’agence CNAC de {{ $employeur->wilaya->des_fr }} à partir du {{ Carbon\Carbon::parse($demande->date_decision)->format("d-m-Y") }} pour retirer votre <b><i>DECISION DE REJET DE REJET DE LA DEMANDE DE REMBOURSEMENT DE LA COTISATION GLOBALE PART PATRONALE DE SECURITE SOCIALE DANS LE CADRE DE LA FORMATION DES TRAVAILLEURS.</i></b></p>
<br />
<p class="text-right">
