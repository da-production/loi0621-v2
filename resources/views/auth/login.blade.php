                            ...
                            <form class="login-form" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 d-flex justify-content-end mb-2">
                                        <small>
                                            <a href="{{ route('employeur.reset') }}">Mot de passe oublier ?</a>
                                        </small>
                                    </div>
                                    ...
                                    <div class="col-12 text-center">
                                        <p class="mb-0 mt-3">
                                            <small class="text-dark mr-2">Vous n'avez pas de compte?</small> 
                                            <a href="{{ route('accueil') }}" class="text-dark font-weight-bold">Inscription</a>
                                        </p>
                                    </div>
                                </div>
                            </form>
