                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="login-page bg-white shadow rounded p-4">
                            <div class="text-center">
                                <h4 class="mb-4">Nouveau mot de passe</h4>  
                            </div>
                            <form class="login-form" action="{{ route('employeur.new.password') }}" method="POST"  autocomplete="off">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="password" class="form-control" autocomplete="false" placeholder="Mot de passe" name="password" required="">
                                            @error('password')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="password" class="form-control" placeholder="Confirmer votre mot de passe" name="password_confirmation" required="">
                                        </div>
                                    </div>
